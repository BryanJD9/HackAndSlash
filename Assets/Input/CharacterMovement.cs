...
//     version 1.14.2
//     from Assets/Input/CharacterMovement.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/CharacterMovement.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CharacterMovement: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""001f49c8-a79f-4968-901b-054df88d957f"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""6cdae2f2-242a-423b-ba89-dd32e953eacb"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""d01d10ef-6ff0-4a56-bbbe-77135b35f08b"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""60cb9826-d0b1-495c-ab22-5ad8fe1d7e74"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""c33c67d0-3e3a-4196-bcf0-0ed0a5668884"",
    ...
    ~@CharacterMovement()
    {
        UnityEngine.Debug.Assert(!m_Move.enabled, "This will cause a leak and performance issues, CharacterMovement.Move.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Jump.enabled, "This will cause a leak and performance issues, CharacterMovement.Jump.Disable() has not been called.");
    }
    ...
    public struct MoveActions
    {
        ...
        /// </summary>
        public MoveActions(@CharacterMovement wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct JumpActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public JumpActions(@CharacterMovement wrapper) { m_Wrapper = wrapper; }
        /// <summary>
